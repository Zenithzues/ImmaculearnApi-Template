...
class User {
  ...
  async findByAccountId(account_id, role) {
    ...
    //   }
      ...
      this.logger.error('Error finding user by account ID', { account_id, role, error });
      throw error;
    }
  }
  ...
  async createPartialGoogleUser({ googleId, email, picture }) {
    try {
      ...
      this.logger.error('Error creating partial Google user', { email, googleId, error });
      throw error;
    }
  }
...
class ProfessorFinder {
  ...
  async findByAccountId(account_id) {
    try {
        ...
        this.logger.error('Error finding professor by account ID', { account_id, error });
        throw error;
    }
  }
}
